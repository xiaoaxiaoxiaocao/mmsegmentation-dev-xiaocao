_base_ = [
    '../../../configs/_base_/models/deeplabv3_r50-d8.py', '../../../configs/_base_/datasets/manipulation.py',
    '../../../configs/_base_/default_runtime.py', '../../../configs/_base_/schedules/schedule_80k.py'
]

model = dict(
    decode_head=dict(num_classes=2),auxiliary_head=dict(num_classes=2)) #自定义篡改数据集为只有一类，加背景 num_class=2
