...
def manipulation_classes():
    """manipulation class names for external use."""
    return ['background', 'manipulation']
...
def manipulation_palette():
    """manipulation palette for external use."""
